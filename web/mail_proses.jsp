                            ...
                            <table class="table table-inbox table-hover">
                                <tbody>
                                    <% try {
                                            ...
                                            String querys = "select * from contact";
                                    ...
                                    %>
                                    <tr class="" onclick="window.location.href = 'mail_edit.jsp?id=<%= rs.getString("id")%>&&userid=<% out.print(userid); %>'">
                                        <td class="inbox-small-cells"><%
                                            %></td>
                                        <td class="view-message  dont-show"><a href="mail_edit.jsp?id=<%= rs.getString("id")%>&&userid=<% out.print(userid);%>"><%= rs2.getString("email")%></a></td>
                                        <td class="view-message "><a href="mail_edit.jsp?id=<%= rs.getString("id")%>&&userid=<% out.print(userid);%>"><%= rs.getString("judul")%></a></td>
                                        <td class="view-message  inbox-small-cells">Status : <%= rs.getString("status")%></td>
