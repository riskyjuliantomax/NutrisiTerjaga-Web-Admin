                                ...
                                <table class="table table-striped table-advance table-hover">
                                    ...
                                    <tbody>
                                        <%    try {
                                                ...
                                                String data = "Select * from produk";
                                    ...
                                    <td>
                                        ...
                                        <a href="delete_produk.jsp?id=<%= rs.getString("id")%>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o " onclick="return confirm('Apakah Yakin Ingin Menghapus data? <%= rs.getString("nama") %> ')" /></i></button>
                                    </td>
                                    </tr>
                                    <% } %>
                                    <%
